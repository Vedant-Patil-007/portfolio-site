...
const Home = () => {
  return (
    <section className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden">
      <div className="flex-grow flex flex-col w-full max-w-7xl mx-auto px-4 pt-4 pb-2">
        {/* Top Row: Hero & Jarvis */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center w-full flex-grow overflow-y-auto lg:overflow-visible">
          ...
          >
            ...
            <motion.h2
              ...
              className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-200/80"
            >
            ...
            <motion.p
              ...
              className="text-cyan-100/70 text-base max-w-xl"
            >
              Architects AI systems that scale beyond the notebook. Specializes in Generative AI (LLMs) and NLP, transforming complex research into production-grade software. Bridges the gap between data science theory and engineering reality using modern MLOps.
            </motion.p>
            ...
            >
              <Link
                to="/projects"
                className="btn-primary bg-cyan-500 hover:bg-cyan-600 text-black font-semibold transition-all duration-300 px-5 py-2 text-sm"
              >
                View Projects
              </Link>
              <Link
                to="/contact"
                className="btn-outline border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 transition-all duration-300 px-5 py-2 text-sm"
              >
                Contact Me
              </Link>
            </motion.div>
          ...
          >
            <div className="scale-90 origin-top-center w-full">
              <JarvisUI />
            </div>
          </motion.div>
        </div>
